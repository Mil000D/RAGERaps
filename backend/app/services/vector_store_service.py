...
class VectorStoreService:
    ...
    def _convert_dict_filter_to_qdrant_filter(
    ...
    async def add_artist_data_batch(
        self, artist_data_list: List[ArtistData]
    ) -> List[str]:
        """
    ...
    async def search_artists(
        ...
        results = await asyncio.to_thread(
            vector_store.similarity_search, query=query, k=k, filter=qdrant_filter
        )
